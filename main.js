...
var TimePickerModal = class extends import_obsidian4.Modal {
  constructor(app, opts) {
    super(app);
  ...
  onOpen() {
    ...
    const submitCustom = () => {
      ...
      if (v === null) {
        new import_obsidian4.Notice("Enter a valid time");
        return;
      }
      this.onPick(v);
      this.close();
